...
class InstallerLog:
    def __init__(self, minLevel=DEFAULT_LEVEL):
        ...
        self.logger = logging.getLogger("pomona")
        self.logger.setLevel(logging.DEBUG)

        # Add a handler for the log file.
        self.addFileHandler(logFile, logging.getLogger("pomona"),
        ...
        # log.
        self.stdoutLogger = logging.getLogger("pomona.stdout")
    ...
    # name falls under infire in the tree.
