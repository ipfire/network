...
class InstallerLog:
	def __init__(self, minLevel=DEFAULT_LEVEL):
		...
		self.logger = logging.getLogger("infire")
		self.logger.setLevel(logging.DEBUG)

		# Add a handler for the log file.
		self.addFileHandler(logFile, logging.getLogger("infire"),
		...
		# log.
		self.stdoutLogger = logging.getLogger("infire.stdout")
